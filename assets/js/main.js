...
app.config(['$routeProvider', function ($routeProvider) {
  $routeProvider
    ...
    .when("/program-specifics", {templateUrl: "partials/ohp-specifics.html", controller: "PageCtrl"})
    .when("/register", {templateUrl: "partials/ohp-register.html", controller: "PageCtrl"})
    .when("/host", {templateUrl: "partials/ohp-host.html", controller: "PageCtrl"})
    .when("/volunteer", {templateUrl: "partials/ohp-volunteer.html", controller: "PageCtrl"})
