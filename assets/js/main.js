...
app.config(['$routeProvider', function ($routeProvider) {
  $routeProvider
    ...
    .when("/program-specifics", {templateUrl: "partials/ohp-specifics.html", controller: "ResourceCtrl"})
    .when("/register", {templateUrl: "partials/ohp-register.html", controller: "ResourceCtrl"})
    .when("/host", {templateUrl: "partials/ohp-host.html", controller: "ResourceCtrl"})
    .when("/volunteer", {templateUrl: "partials/ohp-volunteer.html", controller: "ResourceCtrl"})
