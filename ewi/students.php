...
Evening with Industry
  ...
  <p>
  UC Berkeley\'s Society of Women Engineers (SWE) is proud to host our 37th annual Evening with Industry (EWI) career fair/dinner event!
...
');
$PATH = "../ewi/sponsors/logos/";
$DIRS = array("patinum/", "golden/", "silver/", "bronze/");
foreach($DIRS as $d){
  $images = Array();
  ...
  if ($d == "platinum/")
    echo("<h3>Platinum Bear Sponsors:</h3>");
