var bg_color_img_box = 'rgba(0,0,0,0.6)'
...
function img_box(self) {
    ...
    img_img_box.onload = function() {
        ...
        if (wimg_img_box > wwin_img_box) {
            idpopup_img_box.getElementsByTagName('img')[0].style.width = '60%'
        }
        else if (himg_img_box > hwin_img_box) {
            idpopup_img_box.getElementsByTagName('img')[0].style.height = '60%'
        ...
        if (himg_img_box < hwin_img_box) {
            ...
            idpopup_img_box.style.paddingTop = '90px'
        }
